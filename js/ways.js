...
function way02(input00) {
    ...
    output00 = stepwiseBuy(input00, rmb2btc_btctrade, '');
    //console.log(output00);

    output01 = withdrawWithFixedFee(output00, 0.005, '');
    //console.log(output00);

    output02 = stepwiseBuy(output01, ltc2btc_btce, '');
    //console.log(output00);

    output03 = withdrawWithPercentFee(output02, fee_ltc_btc_e_out_percent, '');
    //console.log(output00);

    output04 = stepwiseSell(output03, rmb2ltc_btctrade, '');
    //console.log(output00);
